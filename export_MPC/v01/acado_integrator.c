...
out[1] = xd[4];
out[2] = xd[5];
out[3] = ((((real_t)(0.0000000000000000e+00)-((((real_t)(2.0000000000000000e+00)*xd[9])*xd[11])+(((real_t)(2.0000000000000000e+00)*xd[10])*xd[12])))*(((u[0]+u[1])+u[2])+u[3]))/(real_t)(7.5000000000000000e-01));
out[4] = ((((((real_t)(2.0000000000000000e+00)*xd[9])*xd[10])-(((real_t)(2.0000000000000000e+00)*xd[11])*xd[12]))*(((u[0]+u[1])+u[2])+u[3]))/(real_t)(7.5000000000000000e-01));
out[5] = (((((real_t)(0.0000000000000000e+00)-(((real_t)(-1.0000000000000000e+00)+(((real_t)(2.0000000000000000e+00)*xd[9])*xd[9]))+(((real_t)(2.0000000000000000e+00)*xd[12])*xd[12])))*(((u[0]+u[1])+u[2])+u[3]))/(real_t)(7.5000000000000000e-01))+(real_t)(9.8100000000000005e+00));
out[6] = ((((((((real_t)(-1.1606526015770585e-01)*u[0])+((real_t)(1.1606526015770585e-01)*u[1]))+((real_t)(1.1606526015770585e-01)*u[2]))-((real_t)(1.1606526015770585e-01)*u[3]))+(((real_t)(2.0999999999999999e-03)*xd[7])*xd[8]))-(((real_t)(4.3000000000000000e-03)*xd[7])*xd[8]))/(real_t)(2.5000000000000001e-03));
out[7] = (((((((((real_t)(-2.5000000000000001e-03)*xd[6])*xd[8])+(((real_t)(4.3000000000000000e-03)*xd[6])*xd[8]))+((real_t)(7.8287006485904559e-02)*u[0]))-((real_t)(7.8287006485904559e-02)*u[1]))+((real_t)(7.8287006485904559e-02)*u[2]))-((real_t)(7.8287006485904559e-02)*u[3]))/(real_t)(2.0999999999999999e-03));
out[8] = ((((((((real_t)(1.5695364238410597e-02)*u[0])+((real_t)(1.5695364238410597e-02)*u[1]))-((real_t)(1.5695364238410597e-02)*u[2]))-((real_t)(1.5695364238410597e-02)*u[3]))-(((real_t)(2.0999999999999999e-03)*xd[6])*xd[7]))+(((real_t)(2.5000000000000001e-03)*xd[6])*xd[7]))/(real_t)(4.3000000000000000e-03));
out[9] = (((((real_t)(-5.0000000000000000e-01)*xd[6])*xd[10])-(((real_t)(5.0000000000000000e-01)*xd[7])*xd[11]))-(((real_t)(5.0000000000000000e-01)*xd[8])*xd[12]));
out[10] = (((((real_t)(5.0000000000000000e-01)*xd[6])*xd[9])-(((real_t)(5.0000000000000000e-01)*xd[7])*xd[12]))+(((real_t)(5.0000000000000000e-01)*xd[8])*xd[11]));
out[11] = (((((real_t)(5.0000000000000000e-01)*xd[6])*xd[12])+(((real_t)(5.0000000000000000e-01)*xd[7])*xd[9]))-(((real_t)(5.0000000000000000e-01)*xd[8])*xd[10]));
out[12] = (((((real_t)(-5.0000000000000000e-01)*xd[6])*xd[11])+(((real_t)(5.0000000000000000e-01)*xd[7])*xd[10]))+(((real_t)(5.0000000000000000e-01)*xd[8])*xd[9]));
}
...
a[0] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.5000000000000000e-01));
a[1] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.5000000000000000e-01));
a[2] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.5000000000000000e-01));
a[3] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.5000000000000000e-01));
a[4] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.5000000000000000e-01));
a[5] = ((real_t)(1.0000000000000000e+00)/(real_t)(7.5000000000000000e-01));
a[6] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.5000000000000001e-03));
a[7] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.5000000000000001e-03));
a[8] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0999999999999999e-03));
a[9] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.0999999999999999e-03));
a[10] = ((real_t)(1.0000000000000000e+00)/(real_t)(4.3000000000000000e-03));
a[11] = ((real_t)(1.0000000000000000e+00)/(real_t)(4.3000000000000000e-03));
...
out[60] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[11]))*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[61] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[12]))*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[62] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[9]))*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[63] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[10]))*(((u[0]+u[1])+u[2])+u[3]))*a[0]);
out[64] = (((real_t)(0.0000000000000000e+00)-((((real_t)(2.0000000000000000e+00)*xd[9])*xd[11])+(((real_t)(2.0000000000000000e+00)*xd[10])*xd[12])))*a[1]);
out[65] = (((real_t)(0.0000000000000000e+00)-((((real_t)(2.0000000000000000e+00)*xd[9])*xd[11])+(((real_t)(2.0000000000000000e+00)*xd[10])*xd[12])))*a[1]);
out[66] = (((real_t)(0.0000000000000000e+00)-((((real_t)(2.0000000000000000e+00)*xd[9])*xd[11])+(((real_t)(2.0000000000000000e+00)*xd[10])*xd[12])))*a[1]);
out[67] = (((real_t)(0.0000000000000000e+00)-((((real_t)(2.0000000000000000e+00)*xd[9])*xd[11])+(((real_t)(2.0000000000000000e+00)*xd[10])*xd[12])))*a[1]);
...
out[77] = ((((real_t)(2.0000000000000000e+00)*xd[10])*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[78] = ((((real_t)(2.0000000000000000e+00)*xd[9])*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[79] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[12]))*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[80] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0000000000000000e+00)*xd[11]))*(((u[0]+u[1])+u[2])+u[3]))*a[2]);
out[81] = (((((real_t)(2.0000000000000000e+00)*xd[9])*xd[10])-(((real_t)(2.0000000000000000e+00)*xd[11])*xd[12]))*a[3]);
out[82] = (((((real_t)(2.0000000000000000e+00)*xd[9])*xd[10])-(((real_t)(2.0000000000000000e+00)*xd[11])*xd[12]))*a[3]);
out[83] = (((((real_t)(2.0000000000000000e+00)*xd[9])*xd[10])-(((real_t)(2.0000000000000000e+00)*xd[11])*xd[12]))*a[3]);
out[84] = (((((real_t)(2.0000000000000000e+00)*xd[9])*xd[10])-(((real_t)(2.0000000000000000e+00)*xd[11])*xd[12]))*a[3]);
...
out[94] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[9])+((real_t)(2.0000000000000000e+00)*xd[9])))*(((u[0]+u[1])+u[2])+u[3]))*a[4]);
out[95] = (real_t)(0.0000000000000000e+00);
out[96] = (real_t)(0.0000000000000000e+00);
out[97] = ((((real_t)(0.0000000000000000e+00)-(((real_t)(2.0000000000000000e+00)*xd[12])+((real_t)(2.0000000000000000e+00)*xd[12])))*(((u[0]+u[1])+u[2])+u[3]))*a[4]);
out[98] = (((real_t)(0.0000000000000000e+00)-(((real_t)(-1.0000000000000000e+00)+(((real_t)(2.0000000000000000e+00)*xd[9])*xd[9]))+(((real_t)(2.0000000000000000e+00)*xd[12])*xd[12])))*a[5]);
out[99] = (((real_t)(0.0000000000000000e+00)-(((real_t)(-1.0000000000000000e+00)+(((real_t)(2.0000000000000000e+00)*xd[9])*xd[9]))+(((real_t)(2.0000000000000000e+00)*xd[12])*xd[12])))*a[5]);
out[100] = (((real_t)(0.0000000000000000e+00)-(((real_t)(-1.0000000000000000e+00)+(((real_t)(2.0000000000000000e+00)*xd[9])*xd[9]))+(((real_t)(2.0000000000000000e+00)*xd[12])*xd[12])))*a[5]);
out[101] = (((real_t)(0.0000000000000000e+00)-(((real_t)(-1.0000000000000000e+00)+(((real_t)(2.0000000000000000e+00)*xd[9])*xd[9]))+(((real_t)(2.0000000000000000e+00)*xd[12])*xd[12])))*a[5]);
...
out[109] = ((((real_t)(2.0999999999999999e-03)*xd[8])-((real_t)(4.3000000000000000e-03)*xd[8]))*a[6]);
out[110] = ((((real_t)(2.0999999999999999e-03)*xd[7])-((real_t)(4.3000000000000000e-03)*xd[7]))*a[6]);
...
out[115] = ((real_t)(-1.1606526015770585e-01)*a[7]);
out[116] = ((real_t)(1.1606526015770585e-01)*a[7]);
out[117] = ((real_t)(1.1606526015770585e-01)*a[7]);
out[118] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.1606526015770585e-01))*a[7]);
...
out[125] = ((((real_t)(-2.5000000000000001e-03)*xd[8])+((real_t)(4.3000000000000000e-03)*xd[8]))*a[8]);
out[126] = (real_t)(0.0000000000000000e+00);
out[127] = ((((real_t)(-2.5000000000000001e-03)*xd[6])+((real_t)(4.3000000000000000e-03)*xd[6]))*a[8]);
...
out[132] = ((real_t)(7.8287006485904559e-02)*a[9]);
out[133] = (((real_t)(0.0000000000000000e+00)-(real_t)(7.8287006485904559e-02))*a[9]);
out[134] = ((real_t)(7.8287006485904559e-02)*a[9]);
out[135] = (((real_t)(0.0000000000000000e+00)-(real_t)(7.8287006485904559e-02))*a[9]);
...
out[142] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0999999999999999e-03)*xd[7]))+((real_t)(2.5000000000000001e-03)*xd[7]))*a[10]);
out[143] = ((((real_t)(0.0000000000000000e+00)-((real_t)(2.0999999999999999e-03)*xd[6]))+((real_t)(2.5000000000000001e-03)*xd[6]))*a[10]);
...
out[149] = ((real_t)(1.5695364238410597e-02)*a[11]);
out[150] = ((real_t)(1.5695364238410597e-02)*a[11]);
out[151] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.5695364238410597e-02))*a[11]);
out[152] = (((real_t)(0.0000000000000000e+00)-(real_t)(1.5695364238410597e-02))*a[11]);
...
out[160] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[11]));
out[161] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[12]));
out[162] = (real_t)(0.0000000000000000e+00);
out[163] = ((real_t)(-5.0000000000000000e-01)*xd[6]);
out[164] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[7]));
out[165] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[8]));
...
out[176] = ((real_t)(5.0000000000000000e-01)*xd[9]);
out[177] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[12]));
out[178] = ((real_t)(5.0000000000000000e-01)*xd[11]);
out[179] = ((real_t)(5.0000000000000000e-01)*xd[6]);
out[180] = (real_t)(0.0000000000000000e+00);
out[181] = ((real_t)(5.0000000000000000e-01)*xd[8]);
out[182] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[7]));
...
out[194] = ((real_t)(5.0000000000000000e-01)*xd[9]);
out[195] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[10]));
out[196] = ((real_t)(5.0000000000000000e-01)*xd[7]);
out[197] = ((real_t)(0.0000000000000000e+00)-((real_t)(5.0000000000000000e-01)*xd[8]));
out[198] = (real_t)(0.0000000000000000e+00);
out[199] = ((real_t)(5.0000000000000000e-01)*xd[6]);
...
out[210] = ((real_t)(-5.0000000000000000e-01)*xd[11]);
out[211] = ((real_t)(5.0000000000000000e-01)*xd[10]);
out[212] = ((real_t)(5.0000000000000000e-01)*xd[9]);
out[213] = ((real_t)(5.0000000000000000e-01)*xd[8]);
out[214] = ((real_t)(5.0000000000000000e-01)*xd[7]);
out[215] = ((real_t)(-5.0000000000000000e-01)*xd[6]);
...
acadoWorkspace.rk_xxx[13] = rk_eta[234];
acadoWorkspace.rk_xxx[14] = rk_eta[235];
acadoWorkspace.rk_xxx[15] = rk_eta[236];
acadoWorkspace.rk_xxx[16] = rk_eta[237];
...
for (i = 0; i < 13; ++i)
{
acadoWorkspace.rk_diffsPrev2[i * 17] = rk_eta[i * 13 + 13];
acadoWorkspace.rk_diffsPrev2[i * 17 + 1] = rk_eta[i * 13 + 14];
acadoWorkspace.rk_diffsPrev2[i * 17 + 2] = rk_eta[i * 13 + 15];
acadoWorkspace.rk_diffsPrev2[i * 17 + 3] = rk_eta[i * 13 + 16];
acadoWorkspace.rk_diffsPrev2[i * 17 + 4] = rk_eta[i * 13 + 17];
acadoWorkspace.rk_diffsPrev2[i * 17 + 5] = rk_eta[i * 13 + 18];
acadoWorkspace.rk_diffsPrev2[i * 17 + 6] = rk_eta[i * 13 + 19];
acadoWorkspace.rk_diffsPrev2[i * 17 + 7] = rk_eta[i * 13 + 20];
acadoWorkspace.rk_diffsPrev2[i * 17 + 8] = rk_eta[i * 13 + 21];
acadoWorkspace.rk_diffsPrev2[i * 17 + 9] = rk_eta[i * 13 + 22];
acadoWorkspace.rk_diffsPrev2[i * 17 + 10] = rk_eta[i * 13 + 23];
acadoWorkspace.rk_diffsPrev2[i * 17 + 11] = rk_eta[i * 13 + 24];
acadoWorkspace.rk_diffsPrev2[i * 17 + 12] = rk_eta[i * 13 + 25];
acadoWorkspace.rk_diffsPrev2[i * 17 + 13] = rk_eta[i * 4 + 182];
acadoWorkspace.rk_diffsPrev2[i * 17 + 14] = rk_eta[i * 4 + 183];
acadoWorkspace.rk_diffsPrev2[i * 17 + 15] = rk_eta[i * 4 + 184];
acadoWorkspace.rk_diffsPrev2[i * 17 + 16] = rk_eta[i * 4 + 185];
}
}
if( resetIntegrator ) {
for (i = 0; i < 1; ++i)
...
acado_diffs( acadoWorkspace.rk_xxx, &(acadoWorkspace.rk_diffsTemp2[ run1 * 221 ]) );
for (j = 0; j < 13; ++j)
{
tmp_index1 = (run1 * 13) + (j);
acadoWorkspace.rk_A[tmp_index1 * 26] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 1] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 2] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 3] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 4] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 5] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 6] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 7] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 8] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 8)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 9] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 9)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 10] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 10)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 11] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 11)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 12] = + acado_Ah_mat[run1 * 2]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 12)];
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 26) + (j)] -= 1.0000000000000000e+00;
acadoWorkspace.rk_A[tmp_index1 * 26 + 13] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 14] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 15] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 2)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 16] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 3)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 17] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 4)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 18] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 5)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 19] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 6)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 20] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 7)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 21] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 8)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 22] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 9)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 23] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 10)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 24] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 11)];
acadoWorkspace.rk_A[tmp_index1 * 26 + 25] = + acado_Ah_mat[run1 * 2 + 1]*acadoWorkspace.rk_diffsTemp2[(run1 * 221) + (j * 17 + 12)];
...
for (i = 0; i < 2; ++i)
{
acadoWorkspace.rk_b[i * 13] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1)];
acadoWorkspace.rk_b[i * 13 + 1] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 17)];
acadoWorkspace.rk_b[i * 13 + 2] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 34)];
acadoWorkspace.rk_b[i * 13 + 3] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 51)];
acadoWorkspace.rk_b[i * 13 + 4] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 68)];
acadoWorkspace.rk_b[i * 13 + 5] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 85)];
acadoWorkspace.rk_b[i * 13 + 6] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 102)];
acadoWorkspace.rk_b[i * 13 + 7] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 119)];
acadoWorkspace.rk_b[i * 13 + 8] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 136)];
acadoWorkspace.rk_b[i * 13 + 9] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 153)];
acadoWorkspace.rk_b[i * 13 + 10] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 170)];
acadoWorkspace.rk_b[i * 13 + 11] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 187)];
acadoWorkspace.rk_b[i * 13 + 12] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (run1 + 204)];
}
if( 0 == run1 ) {
det = acado_solve_dim26_system( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim26_perm );
}
...
acadoWorkspace.rk_b[tmp_index1] = - acadoWorkspace.rk_diffsTemp2[(i * 221) + (tmp_index2 + 13)];
}
}
acado_solve_dim26_system_reuse( acadoWorkspace.rk_A, acadoWorkspace.rk_b, acadoWorkspace.rk_dim26_perm );
for (i = 0; i < 2; ++i)
...
for (i = 0; i < 13; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 17) + (run1 + 13)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.2500000000000001e-02 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)1.2500000000000001e-02;
}
}
...
{
tmp_index2 = (j) + (i * 13);
rk_eta[tmp_index2 + 13] = acadoWorkspace.rk_diffsNew2[(i * 17) + (j)];
}
for (j = 0; j < 4; ++j)
{
tmp_index2 = (j) + (i * 4);
rk_eta[tmp_index2 + 182] = acadoWorkspace.rk_diffsNew2[(i * 17) + (j + 13)];
}
}
}
else {
...
{
tmp_index2 = (j) + (i * 13);
rk_eta[tmp_index2 + 13] = + acadoWorkspace.rk_diffsNew2[i * 17]*acadoWorkspace.rk_diffsPrev2[j];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 1]*acadoWorkspace.rk_diffsPrev2[j + 17];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 2]*acadoWorkspace.rk_diffsPrev2[j + 34];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 3]*acadoWorkspace.rk_diffsPrev2[j + 51];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 4]*acadoWorkspace.rk_diffsPrev2[j + 68];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 5]*acadoWorkspace.rk_diffsPrev2[j + 85];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 6]*acadoWorkspace.rk_diffsPrev2[j + 102];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 7]*acadoWorkspace.rk_diffsPrev2[j + 119];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 8]*acadoWorkspace.rk_diffsPrev2[j + 136];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 9]*acadoWorkspace.rk_diffsPrev2[j + 153];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 10]*acadoWorkspace.rk_diffsPrev2[j + 170];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 11]*acadoWorkspace.rk_diffsPrev2[j + 187];
rk_eta[tmp_index2 + 13] += + acadoWorkspace.rk_diffsNew2[i * 17 + 12]*acadoWorkspace.rk_diffsPrev2[j + 204];
}
for (j = 0; j < 4; ++j)
{
tmp_index2 = (j) + (i * 4);
rk_eta[tmp_index2 + 182] = acadoWorkspace.rk_diffsNew2[(i * 17) + (j + 13)];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17]*acadoWorkspace.rk_diffsPrev2[j + 13];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 1]*acadoWorkspace.rk_diffsPrev2[j + 30];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 2]*acadoWorkspace.rk_diffsPrev2[j + 47];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 3]*acadoWorkspace.rk_diffsPrev2[j + 64];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 4]*acadoWorkspace.rk_diffsPrev2[j + 81];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 5]*acadoWorkspace.rk_diffsPrev2[j + 98];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 6]*acadoWorkspace.rk_diffsPrev2[j + 115];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 7]*acadoWorkspace.rk_diffsPrev2[j + 132];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 8]*acadoWorkspace.rk_diffsPrev2[j + 149];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 9]*acadoWorkspace.rk_diffsPrev2[j + 166];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 10]*acadoWorkspace.rk_diffsPrev2[j + 183];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 11]*acadoWorkspace.rk_diffsPrev2[j + 200];
rk_eta[tmp_index2 + 182] += + acadoWorkspace.rk_diffsNew2[i * 17 + 12]*acadoWorkspace.rk_diffsPrev2[j + 217];
}
}
}
resetIntegrator = 0;
